(function () {
  ...
  entrance.isElemInView = function (elem) {
    ...
    return (
      ...
      (rect.top + entrance.heightOffset >= 0 &&
        rect.top + entrance.heightOffset <= window.innerHeight) ||
      // The bottom is in view: bottom position is greater than 0 and greater than the window height
      (rect.bottom + entrance.heightOffset >= 0 &&
        rect.bottom + entrance.heightOffset <= window.innerHeight) ||
